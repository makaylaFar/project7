...
class spaceShip(SphereCollideObject):
    def __init__(self, loader: Loader, modelPath: str, parentNode: NodePath, nodeName: str, texPath: str, posVec: Vec3, scaleVec: float, task, render, accept: Callable[[str, Callable], None], shipTrav):
        ...
        self.accept = accept                                                                                            
        self.loader = loader
        self.colliders = CollisionHandlerPusher()
        self.pusher = shipTrav
        ...
        self.colliders.addCollider(self.collisionNode, self.modelNode)
        self.shipTraverser.addCollider(self.colliders, self.pusher)
